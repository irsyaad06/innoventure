            ...
            <tbody>
                ...
                >
                    ...
                    <td class="px-6 py-4 text-center">
                        <router-link
                            :to="`/detail-sayembara/${progress.id}`"
...
import { useSayembaraProgressStore } from "../stores/sayembaraProgress";
import { useJuriStore } from "../stores/juriStore"; // 1. Impor store juri

const progressStore = useSayembaraProgressStore();
