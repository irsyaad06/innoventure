<template>
    <div class="relative min-h-screen w-full bg-gray-900">
        ...
        <div class="relative z-10 flex items-center justify-center min-h-screen p-4">
            ...
            <div v-if="juriStore.isAuthenticated && juri" class="w-full max-w-2xl bg-gray-800/50 backdrop-blur-lg border border-white/10 rounded-2xl shadow-2xl p-8 text-white">
                <h1 class="text-3xl font-extrabold text-center mb-8">Profil Juri</h1>
                ...
                <div class="space-y-4">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value capitalize">{{ juri.role }}</span>
                    </div>
                    <div class="info-row">
                ...
                <div class="mt-10 text-center">
                    <button @click="handleLogout" class="px-6 py-2 bg-red-600 hover:bg-red-700 rounded-lg font-semibold transition-colors">
                        Logout
                    </button>
                </div>
            </div>
