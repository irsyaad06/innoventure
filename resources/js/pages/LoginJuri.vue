<template>
    <div class="relative min-h-screen w-full bg-gray-900">
        ...
        <div class="relative z-10 flex items-center justify-center min-h-screen p-4">
            ...
            <div class="w-full max-w-md bg-gray-800/50 backdrop-blur-lg border border-white/10 rounded-2xl shadow-2xl p-8">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-extrabold text-white">Portal Juri</h1>
                ...
                <form @submit.prevent="handleLogin" class="space-y-6">
                    ...
                    <div v-if="errorMsg" class="text-center bg-red-500/20 text-red-300 text-sm p-3 rounded-lg">
                        {{ errorMsg }}
                    </div>
...
const email = ref('juri@gmail.com'); // Nilai default untuk memudahkan testing
const password = ref('12345678');   // Nilai default untuk memudahkan testing
const errorMsg = ref('');
...
const handleLogin = async () => {
    ...
    try {
        ...
        router.push('/info-juri'); // Arahkan ke halaman info juri
    } catch (error) {
        errorMsg.value = juriStore.error;
    }
};
...
onMounted(async () => {
    ...
    // If already authenticated, redirect to info-juri
...
.form-input {
    ...
    border-radius: 0.5rem; background-color: rgb(31 41 55);
    color: white; border: 1px solid rgb(75 85 99);
    transition: all 0.2s ease-in-out;
}
.form-input:focus {
    outline: none; border-color: rgb(59 130 246);
